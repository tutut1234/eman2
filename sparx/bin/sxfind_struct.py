...
def main():
	...
	if len(args) != 2:
		...
		if options.MPIGA:
			pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from development import cml2_main_mpi
			...
			pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from applications import cml_find_structure_MPI2
			global_def.BATCH = True
			...
			pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from applications import cml_find_structure_main
			global_def.BATCH = True
