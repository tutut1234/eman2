...
def main():
	...
	else:              mask = sparx_utilities.get_image( args[3] )
	...
	sparx_applications.recons3d_f(prj_stack, vol_stack, fsc_curve, mask, options.CTF, options.snr, options.sym, options.list, options.group, options.npad, options.verbose, options.MPI)
