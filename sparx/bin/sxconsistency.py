...
def rotate_angles(angleset1, angleset2, rot, indexes=None):
	...
	"""
	pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from EMAN2 import Transform, Vec2f
...
def average_trans(params):
	...
	pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from math import sqrt, degrees, radians, acos
	nn = lem(params[0])
	avgtrans = [None]*nn
	pixer   = [0.0]*nn
	for j in range(nn):
