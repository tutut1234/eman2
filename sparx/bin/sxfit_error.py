...
pass#IMPORTIMPORTIMPORT import numpy
pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from numpy import linalg as LA
pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from numpy import array, dot
...
pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from os import system
pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from sys import argv
...
def red(angle):
	...
	pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from math import floor
	return angle-360*numpy.floor((angle+180)/360)



# read args from command line ---------------------------------
progname = os.os.path.basename(sys.argv[0])
...
if len(args)==3:
	...
	user_mask = False
segName = os.os.path.splitext(os.path.basename(segFile))[0]
...
for i in range(nt1):
	...
	for k in range(lpar):
		if k<lpar-3: params[k] = shake_ang_1*(2.0*numpy.random()-1.0)
		else: params[k] = shake_shift_1*(2.0*numpy.random()-1.0)
...
for cycle in range(max_cycles):
	...
	for i in range(nt2):
		for k in range(lpar):
			if k<lpar-3: params[k] = shake_ang_2*(2.0*numpy.random()-1.0)
			else: params[k] = shake_shift_2*(2.0*numpy.random()-1.0)
