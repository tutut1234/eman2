...
def main():
	...
	if len(args) < 3 or len(args) > 4:
		...
		if options.MPI:
			...
			if options.kmeans:
				pass#IMPORTIMPORTIMPORT from applications import Kmref_ali3d_MPI
