...
def main():
	...
	if options.old == False and len(args) != 3 or options.old and len(args) != 4:
		...
		if options.old:
			pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from development import realid
			...
			pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT pass#IMPORTIMPORTIMPORT from development import realignment
