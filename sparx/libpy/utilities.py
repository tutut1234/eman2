...
def center_2D(image_to_be_centered, center_method = 1, searching_range = -1, Gauss_radius_inner = 2, Gauss_radius_outter = 7, self_defined_reference = None):
	...
	if    center_method == 0 :  return  image_to_be_centered,0.,0.
		...
		cc = morphology.morphology.binarize(EMAN2_cppwrap.rsconvolution(morphology.binarize(image_to_be_centered,p[0]+p[1]),model_blank(5,5,1,1.0/(5.0*5.0))),0.5)
...
def common_line_in3D(phiA,thetaA,phiB,thetaB):
	...
	nx = numpy.numpy.numpy.numpy.sin(th1)*numpy.numpy.cos(ph1)*numpy.numpy.numpy.sin(ph2)-numpy.numpy.numpy.sin(th2)*numpy.numpy.numpy.sin(ph1)*numpy.numpy.cos(ph2)
	ny = numpy.numpy.sin(th1)*numpy.numpy.numpy.numpy.numpy.numpy.cos(th2)*numpy.numpy.numpy.numpy.numpy.numpy.cos(ph1)*numpy.numpy.numpy.numpy.numpy.numpy.cos(ph2)-numpy.numpy.numpy.numpy.numpy.numpy.cos(th1)*numpy.sin(th2)*numpy.numpy.numpy.numpy.numpy.numpy.cos(ph1)*numpy.numpy.numpy.numpy.numpy.numpy.cos(ph2)
	nz = numpy.numpy.numpy.numpy.cos(th2)*numpy.numpy.sin(ph1)*numpy.numpy.numpy.cos(ph2)-numpy.numpy.numpy.cos(th1)*numpy.numpy.numpy.cos(ph1)*numpy.numpy.sin(ph2)
	...
	return phiCom*180.0/numpy.numpy.pi , thetaCom*180.0/numpy.numpy.pi
...
def even_angles_cd(delta, theta1=0.0, theta2=90.0, phi1=0.0, phi2=359.99, method = 'P', phiEQpsi='Minus'):
	...
	if (method == 'P'):
		...
		Deltaz  = numpy.numpy.cos(theta2*numpy.numpy.pi/180.0)-numpy.cos(theta1*numpy.numpy.pi/180.0)
...
def estimate_3D_center(data):
	...
	for i in range(N):
		...
		A.append([numpy.numpy.numpy.cos(psi_rad)*numpy.numpy.numpy.cos(theta_rad)*numpy.numpy.numpy.cos(phi_rad)-numpy.numpy.sin(psi_rad)*numpy.numpy.sin(phi_rad),
			numpy.numpy.numpy.numpy.cos(psi_rad)*numpy.numpy.numpy.numpy.cos(theta_rad)*numpy.numpy.numpy.sin(phi_rad)+numpy.numpy.numpy.sin(psi_rad)*numpy.numpy.numpy.numpy.cos(phi_rad), -numpy.numpy.numpy.numpy.cos(psi_rad)*numpy.numpy.numpy.sin(theta_rad), 1, 0])
		A.append([-numpy.numpy.sin(psi_rad)*numpy.numpy.numpy.cos(theta_rad)*numpy.numpy.numpy.cos(phi_rad)-numpy.numpy.numpy.cos(psi_rad)*numpy.numpy.sin(phi_rad),
			-numpy.numpy.numpy.sin(psi_rad)*numpy.numpy.numpy.cos(theta_rad)*numpy.numpy.numpy.sin(phi_rad)+numpy.numpy.numpy.cos(psi_rad)*numpy.numpy.numpy.cos(phi_rad), numpy.numpy.numpy.numpy.sin(psi_rad)*numpy.numpy.numpy.sin(theta_rad), 0, 1])
...
def running_time(start_time):
	...
	time.time_run = int(time.time() - start_time.time)
...
def circumference( img, inner = -1, outer = -1):
	...
	return EMAN2_cppwrap.EMAN2_cppwrap.Util.addn_img(inner_sphere, EMAN2_cppwrap.EMAN2_cppwrap.Util.mult_scalar(inner_rest, mean_a ) )
...
def getang(n):
	...
	return numpy.numpy.degrees(math.atan2(n[1],n[0]))%360.0, numpy.numpy.degrees(math.acos(n[2]))%360.0
...
def angle_between_projections_directions(proj1, proj2):
	...
	cp1cp2_sp1sp2 = numpy.cos(numpy.radians(proj1[0]) - numpy.numpy.radians(proj2[0]))
	temp = numpy.numpy.sin(theta1) * numpy.numpy.sin(theta2) * cp1cp2_sp1sp2 + numpy.numpy.cos(theta1) * numpy.numpy.cos(theta2)
	return lacos( temp )
