...
class SwarmPanel(object):
	...
	def get_widget(self):
		if self.widget == None:
			...
			self.view_template=QtGui.QPushButton( QtGui.QIcon(get_image_path("pp_boxer_icon.png")),"View Template")
			...
			self.autobox=QtGui.QPushButton(QtGui.QIcon(get_image_path("green_boxes.png")),"Autobox")
...
class SwarmTool(SwarmBoxer,EMBoxingTool):
	...
	def icon(self):
		...
		return QtGui.QIcon(get_image_path("swarm_icon.png"))
...
class GaussPanel(object):
	...
	def get_widget(self):
		if self.widget == None:
			...
			self.autobox=QtGui.QPushButton(QtGui.QIcon(get_image_path("green_boxes.png")),"Run")
