...
class EMProjectManager(QtGui.QMainWindow):
	...
	def __init__(self):
		...
		self.pm_icon = self.pm_icon_default = get_image_path("EMAN2Icon.png")
	...
	def _onModeChange(self, idx):
		...
		if idx == 1 or idx == 2: self.pm_icon = get_image_path("tomoseg.png")
		else: self.pm_icon = get_image_path("EMAN2Icon.png")
...
class TheHelp(QtGui.QWidget):
	...
	def getToolBar(self):
		...
		hbox = QtGui.QHBoxLayout()
		hbox.addWidget(PMIcon(get_image_path("SirEMAN2.png")))
